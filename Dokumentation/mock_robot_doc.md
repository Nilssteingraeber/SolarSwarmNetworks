...
```python
    ...
    self.nodes[nid] = {
        ...
        'cpu': ?, # null | float
        'activity': ?, # null | str
        'point': {'x': ?, 'y': ?, 'z': ?}, # null | floats
        'orientation': {'x': ?, 'y': ?, 'z': ?, 'w': ?}, # null | floats
        'ipv4': ?, # null | str
        'ipv6': ?, # null | str
        'mac': ?, # null | str
