...
```bash
    ...
    sudo avahi-autoipd bat0
```
![Eigene MAC mit batctl o nicht sichtbar](<Screenshots/aus_Einarbeitung Netzwerke/batman-adv/batctl o zeigt sich selbst nicht.png>)
...
![Ausgaben nach sauberem Start](<Screenshots/aus_Einarbeitung Netzwerke/batman-adv/skript3_sauber nach Start.png>)
![Erfolgreicher Ping](<Screenshots/aus_Einarbeitung Netzwerke/batman-adv/skript3_erfolgreicher ping über bat0.png>)

### Erneuter Labortest
Mit zwei NUCS wurde `batman-adv_setup3.bash` erneut im Labor getestet.

![Skript erfolgreich ausgeführt](<Screenshots/aus_Einarbeitung Netzwerke/batman-adv/skript3_erfolgreich auf NUC aus Labor.png>)

![iw info](<Screenshots/aus_Einarbeitung Netzwerke/batman-adv/skript3_iw info richtig.png>)

![batctl o zeigt originator](<Screenshots/aus_Einarbeitung Netzwerke/batman-adv/batctl o_zeigt originator aus Labor.png>)

![batctl ping erreicht MAC-Adresse](<Screenshots/aus_Einarbeitung Netzwerke/batman-adv/batctl ping_erreicht originator aus Labor.png>)